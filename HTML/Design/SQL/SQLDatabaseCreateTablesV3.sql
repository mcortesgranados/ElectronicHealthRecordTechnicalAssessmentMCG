...
-- Volcando estructura para tabla ehr_system.patient_questions_responses
CREATE TABLE IF NOT EXISTS `patient_questions_responses` (
  `id` char(36) NOT NULL DEFAULT (uuid()),
  `patient_id` int DEFAULT NULL,
...
-- Volcando datos para la tabla ehr_system.patient_questions_responses: ~0 rows (aproximadamente)
